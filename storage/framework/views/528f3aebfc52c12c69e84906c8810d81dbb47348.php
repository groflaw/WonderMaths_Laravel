...
<body>
        ...
        <div class="main-wrapper main-wrapper-1">
            ...
            <div class="main-content">
                ...
                <div class="modal fade" id="addSalesRepModal" tabindex="-1" role="dialog" data-backdrop="static"
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <form action="<?php echo e(route('add-sales-rep')); ?>" method="post" id="form-mmt-addsalesrep"
                                name="form-mmt-addsalesrep">
                                <?php echo csrf_field(); ?>

                                <div class="modal-header">
                                    <h5 class="modal-title" id="addSalesRepModalTitle">Add Sales Representative</h5>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="text" class="form-control" maxlength="10"
                                            name="add_mobile_no" id="add_mobile_no">
                                        <div class="invalid-feedback" data-error="mobile_no"></div>
                                    </div>
                                    <div class="form-group mb-2">
                                        <label for="add_email">Email</label>
                                        <input type="text" class="form-control" maxlength="50" name="add_email"
                                            id="add_email">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="invalid-feedback" data-error="location"></div>
                                    </div>
                                </div>
                ...
                <div class="modal fade" id="editSalesRepModal" tabindex="-1" role="dialog" data-backdrop="static"
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <form action="<?php echo e(route('edit-sales-rep')); ?>" method="put" id="form-mmt-editsalesrep"
                                ...
                                <div class="modal-header">
                                    <h5 class="modal-title" id="editSalesRepModalTitle">Edit Sales Representative</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="text" class="form-control" maxlength="10"
                                            name="edit_mobile_no" id="edit_mobile_no">
                                        <div class="invalid-feedback" data-error="mobile_no"></div>
                                    </div>
                                    <div class="form-group mb-2">
                                        <label for="edit_email">Email</label>
                                        <input type="text" class="form-control" maxlength="50" name="edit_email"
                                            id="edit_email">
                                        <div class="invalid-feedback" data-error="email"></div>
                                    </div>
                                    <div class="form-group mb-2">
    ...
    <script src="<?php echo e(asset('assets/js/page/vsalesreps.js?v=04012021F')); ?>"></script>
</body>

</html>
<?php /**PATH C:\K\freelancer\Anish\mmt-web-admin_25072022\resources\views/admin/salesreps.blade.php ENDPATH**/ ?>