                ...
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="dropdown active">
                            <a href="<?php echo e(route('promo_codes.index')); ?>" class="nav-link">
                ...
                <div class="modal fade" id="addSalesRepModal" tabindex="-1" role="dialog" data-backdrop="static"
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <form action="<?php echo e(route('promo_codes.store')); ?>" method="post" id="form-mmt-addsalesrep"
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <select type="text" class="form-control" maxlength="50" name="add_byrole"
                                            id="add_email">
                            ...
                            <form action="<?php echo e(route('edit-sales-rep')); ?>" method="put" id="form-mmt-editsalesrep"
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <select type="text" class="form-control" maxlength="50" name="edit_email"
                                            id="edit_email">
                                            <option value="1">Sponser</option>
                                            <option value="2">Influencer</option>
                                            <option value="3">Sales Company</option>
...
<?php /**PATH C:\K\freelancer\Anish\mmt-web-admin_25072022\resources\views/admin/promo_code.blade.php ENDPATH**/ ?>